...
Run: 2026-08-28 04:00 UTC · tickers: BTC ETH SOL · window: 4y
...
|---|---|---|---|
| A. Structural | Unit test suite | **PASS** | 424 tests passed |
...
| D. Launch readiness | Outcomes file fresh (updated within 48h) | **PASS** | last resolved 5h ago |
...
| C. Deployment | Signal log is fresh | **PASS** | 1771 rows, newest 0.0h old [origin/main] |
