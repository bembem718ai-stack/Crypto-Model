...
Run: 2026-09-01 18:29 UTC · tickers: BTC ETH SOL · window: 4y
...
|---|---|---|---|
| A. Structural | Unit test suite | **PASS** | 598 tests passed |
...
| C. Deployment | Signal log is fresh | **PASS** | 1791 rows, newest 3.1h old [origin/main] |
